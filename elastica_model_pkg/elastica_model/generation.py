...
def run_generation(uz_x_start, uz_x_end=None, n_layers=1,
    ...
    uz_x_end          : (optional) float e.g. 0.92  to generate data for multiple layers
    n_layers          : (optional) int no. of layers
    n_workers         : (optional) int no of cpu threads to be used
    Returns
    -------
    total                : int
