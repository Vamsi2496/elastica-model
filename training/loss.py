...
class ElasticaLoss:
    ...
    def __call__(self, model, x, y, arc_norm, theta_true, need_stiffness=False):
        ...
        w = torch.tensor([Config.FX_WEIGHT, Config.FY_WEIGHT, Config.M_WEIGHT, Config.M_WEIGHT], dtype=torch.float64, device=device)
        ...
        loss_stiff = torch.tensor(0.0, dtype=torch.float64, device=device)
