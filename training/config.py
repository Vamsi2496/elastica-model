...
class Config:
    ...
    WEIGHTED_D_SAMPLING = True
    D_WEIGHT_BINS       = 50   # number of histogram bins for computing d-weights
    ...
    LOSS_SCHEDULE = [
        ...
        #("FX_WEIGHT",     50,   20,   0.0),   # 0→5 starting epoch 50
        #("M_WEIGHT",      50,   20,   0.0),   # 0→10 starting epoch 50
    ]
