...
This repository consists of code to generate required number of layered data to get the initial guess and the boundary points of snapping. The data is generated using AUTO 07P
...
Using the mesh and initial data, new data can be generated and appended to the .h5 file and rtree is updated.
...
The range of layers and their spacing. update it in "initial_data_generation/initial_data_generation.auto". Default is \[ 0.6 :0.01: 0.99 \]
...
## Results
The .h5 file consists of phi1, phi2, d, Fx, Fy, Moment at left clamp and Moment at right clamp, Energy, arc length and corresponding theta and number of inflection points of the profile
